...
- **Elite drums — remaining features** (MVP gem placement + colours + width + SP done; audit found no note-dropping bugs left):
  ...
  - **Hi-hat pedal: Pedal(72)/Stomp/Splash** → cols 10/11 (reserved in `LANE_COUNT=12`) unmapped; needs mini-kick-bar rendering + `isEliteCymbalLane` splash case.
  - **Flam + hi-hat open/closed/indifferent** (upper octave 84–90) — modifier parsing + gem variants.
