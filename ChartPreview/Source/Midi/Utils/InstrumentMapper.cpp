...
uint InstrumentMapper::getGuitarColumn(uint pitch, SkillLevel skill)
{
...
uint InstrumentMapper::getDrumColumn(uint pitch, SkillLevel skill, bool kick2xEnabled)
{
...
std::vector<uint> InstrumentMapper::getGuitarPitchesForSkill(SkillLevel skill)
{
    using Guitar = MidiPitchDefinitions::Guitar;
    switch (skill)
    {
...
std::vector<uint> InstrumentMapper::getDrumPitchesForSkill(SkillLevel skill)
{
    using Drums = MidiPitchDefinitions::Drums;
    switch (skill)
    {
...
bool InstrumentMapper::isDrumKick(uint pitch)
{
    using Drums = MidiPitchDefinitions::Drums;
    Drums note = (Drums)pitch;
...
bool InstrumentMapper::isSustainedModifierPitch(uint pitch)
{
    using Guitar = MidiPitchDefinitions::Guitar;
    using Drums = MidiPitchDefinitions::Drums;
