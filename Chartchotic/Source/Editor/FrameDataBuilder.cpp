                                   ...
                                   MidiInterpreter& interpreter)
{
    ...
    out.gridlines = GridlineGenerator::generateGridlines(tempoTimeSigMap, extendedStart, trackWindowEndPPQ, cursorPPQ, ppqToTime, ctx.stepDivision, ctx.tuplet);
                                          ...
                                          const FrameContext& ctx)
{
    ...
    TimeBasedGridlineMap sharedGridlines = GridlineGenerator::generateGridlines(
        tempoTimeSigMap, extendedStart, trackWindowEndPPQ, cursorPPQ, ppqToTime, ctx.stepDivision, ctx.tuplet);
